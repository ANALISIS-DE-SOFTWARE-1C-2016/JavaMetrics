package unlam.analisisdesoftware.gestordelibros;
...
public class Main {
	...
	public static void main(String[] args) {
        ...
        do {
            ...
            case 1:
                ...
                break;
            case 3:
				// Separamos la funcionalidad de actualizacion seleccionada.
				actualizarLibro(dato);
                break;
            case 4:
                vector.remove(dato);
    ...
    /**
    *	Este metodo representa la funcionalidad de actualizacion de libros.
    *	@param dato		instancia de la clase Libro a actualizar.
    */
    public static void actualizarLibro(Libro dato) {
    	int subopcion;
